    ...
    return (
        <div className="max-w-7xl mx-auto py-[80px]">
            <div className="grid grid-cols-[568px_568px] justify-between items-center gap-16">
                ...
                <div className={clsx("space-y-[58px]", reversed ? "order-first" : "order-last")}>
                    ...
                    <Button className="py-[22px] px-[20px] bg-[#2D343E] rounded-2xl text-lg font-semibold hover:bg-[#2D343E]/95 cursor-pointer">Details of work</Button>
                </div>
            </div>
        </div>
    )
