    ...
    return (
        <div className="space-y-6">
            ...
            <div className="max-w-[672px] h-auto relative">
                <Input aria-label="Search for products, solutions, or applications" className="w-full h-[56px] bg-whtext-white placeholder:text-base pl-6" placeholder="Search for products, solutions, or applications" />
